...
public class SearchProductByQtyInStock {
	...
	public static void main(String[] args) throws Throwable {
		...
		String ProductName4 = eutil.getStringData("Sheet1",14,0);
		String inStock = eutil.getStringData("Sheet1",14,4);
	     ...
	     driver.findElement(By.name("productname")).sendKeys(ProductName4);
	     driver.findElement(By.id("qtyinstock")).sendKeys(inStock);
	     ...
	     sel.selectByVisibleText("Qty. in Stock");
	     
	     WebElement searchFor = driver.findElement(By.xpath("//input[@name='search_text']"));
	     
	     JavascriptExecutor jse = (JavascriptExecutor) driver;
	     jse.executeScript("arguments[0].value='"+inStock+"';", searchFor);
