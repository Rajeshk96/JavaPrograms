...
public class SearchProductByPartNumber {
...
public static void main(String[] args) throws Throwable {
		...
		String ProductName2 = eutil.getStringData("Sheet1",12,0);
		String PartNumber = eutil.getStringData("Sheet1", 12, 2);
	     ...
	     driver.findElement(By.name("productname")).sendKeys(ProductName2);
	     ...
	     sel.selectByVisibleText("Part Number");
	     
	     WebElement searchFor = driver.findElement(By.xpath("//input[@name='search_text']"));
	     
	     JavascriptExecutor jse = (JavascriptExecutor) driver;
	     jse.executeScript("arguments[0].value='"+PartNumber+"';", searchFor);
