...
public class SearchProductByCommissionRate {
	...
	String ProductName3 = eutil.getStringData("Sheet1",13,0);
    ...
    if(BROWSER.equals("chrome")) {
     ...
     driver.findElement(By.name("productname")).sendKeys(ProductName3);
     ...
     sel.selectByVisibleText("Commission Rate");
     
     WebElement searchFor = driver.findElement(By.xpath("//input[@name='search_text']"));
     
     JavascriptExecutor jse = (JavascriptExecutor) driver;
     jse.executeScript("arguments[0].value='"+CommissionRate+"';", searchFor);
